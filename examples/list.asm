...
List: .word 11, 14, type_str5, .Object.abort, .Object.type_name, .Object.copy, .List.isNil, .List.head, .List.tail, .List.cons
Cons: .word 12, 13, type_str6, .Object.abort, .Object.type_name, .Object.copy, .Cons.isNil, .Cons.head, .Cons.tail, .List.cons, .Cons.init
Main: .word 8, 9, type_str7, .Object.abort, .Object.type_name, .Object.copy, .IO.out_string, .IO.out_int, .IO.in_string, .IO.in_int, .Main.print_list, .Main.main