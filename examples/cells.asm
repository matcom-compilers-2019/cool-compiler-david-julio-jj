...
li $t0, 0 #.CellularAutomaton.cell_left_neighbor
lw $t0, 16($fp)
sw $t0, ($sp)
subu $sp, $sp, 4
li $v0, 9
...
li $t0, 0 #.CellularAutomaton.cell_right_neighbor
lw $t0, 16($fp)
sw $t0, ($sp)
subu $sp, $sp, 4
lw $a0, 12($fp)
...
type_str4: .asciiz "IO"
type_str5: .asciiz "CellularAutomaton"
...
CellularAutomaton: .word 8, 9, type_str5, .Object.abort, .Object.type_name, .Object.copy, .IO.out_string, .IO.out_int, .IO.in_string, .IO.in_int, .CellularAutomaton.init, .CellularAutomaton.print, .CellularAutomaton.num_cells, .CellularAutomaton.cell, .CellularAutomaton.cell_left_neighbor, .CellularAutomaton.cell_right_neighbor, .CellularAutomaton.cell_at_next_evolution, .CellularAutomaton.evolve
