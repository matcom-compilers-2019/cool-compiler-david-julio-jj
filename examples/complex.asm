...
Complex: .word 10, 11, type_str6, .Object.abort, .Object.type_name, .Object.copy, .IO.out_string, .IO.out_int, .IO.in_string, .IO.in_int, .Complex.init, .Complex.print, .Complex.reflect_0, .Complex.reflect_X, .Complex.reflect_Y