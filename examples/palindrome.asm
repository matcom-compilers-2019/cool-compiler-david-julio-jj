...
"
msg1: .asciiz "that was a palindrome
"
msg2: .asciiz "that was not a palindrome
"
buffer: .space 1024
...
Main: .word 8, 9, type_str5, .Object.abort, .Object.type_name, .Object.copy, .IO.out_string, .IO.out_int, .IO.in_string, .IO.in_int, .Main.pal, .Main.main